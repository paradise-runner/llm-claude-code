...
class ClaudeCodeBase(llm.Model):
    ...
    def get_claude_command(self):
        ...
        if hasattr(self, 'options') and self.options and hasattr(self.options, 'claude_path') and self.options.claude_path:
        ...
        try:
            ...
            if hasattr(prompt, 'attachments') and prompt.attachments:
                ...
                for attachment in prompt.attachments:
                    ...
                    elif hasattr(attachment, 'path') and attachment.path and os.path.exists(attachment.path):
            ...
            try:
                ...
                if result.returncode == 0:
                    ...
                    error_msg = f"Claude Code error (exit code {result.returncode}):\n{result}"
                    yield error_msg
